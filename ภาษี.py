...
def calculate_salary(salary, ot_time, ot_rate, tax_rate):
    gross_salary = salary + (ot_time * ot_rate)
    tax = gross_salary * tax_rate
    net_pay = gross_salary - tax
    return net_pay,tax_rate,gross_salary
emp_1=calculate_salary(15000, 10, 100, 0.07)
emp_2=calculate_salary(20000, 5, 150, 0.07)
emp_3=calculate_salary(25000, 8, 200, 0.07)
